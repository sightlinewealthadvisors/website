...
const investmentManagementEvents: TimelineEvent[] = [
  ...
  return (
    <div>
            <Head>
        <title>Our Services | Sightline Wealth Advisors</title>
        <meta name="description" content="Experience our comprehensive financial planning and investment management services. From establishing goals to strategic portfolio management, we guide your financial journey." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Financial Planning & Investment Services | Sightline Wealth Advisors" />
        <meta property="og:description" content="Discover our six-step financial planning process and four-phase investment management approach. Partner with CFP® professionals for your wealth management needs." />
